...
//convert?q=USD_BRL&compact=ultra&apiKey=856f740fb0f137faf6a2
...
class Conversor extends Component {
    ...
    async converter(){
        ...
        const response = await api.get(`convert?q=${de_para}&compact=ultra&apiKey=856f740fb0f137faf6a2`);
...
render(){
    ...
    return(
        <View style={styles.container}>
            <Text style={styles.titulos}> {moedaA} para {moedaB} </Text>
            <TextInput 
